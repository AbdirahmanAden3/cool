...
<body class="g-sidenav-show  bg-gray-200">
    ...
    require_once("concection.php");
    $id = $_GET['id'];
    $query =  "SELECT * FROM  careate where id = $id";
    ...
    <div class="container">
        <div class="container" style="margin-left: 320px; width: 70%;">
            <form method="post">
                ...
                <div class="mb-3">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="clas" value='<?php echo $row['className']?>'>
                        </div>

                        <div class="col-md-6">
                            <label for="exampleInputPassword1" class="form-label">Abbr</label>
                            <input type="text" class="form-control" name="Abrr" value='<?php echo $row['Abrr'] ?>'>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="text-end ">
                    <button type="submit" class="btn btn-danger" name="save">update </button>
                </div>
            </form>
        </div>
